...
export const jaJP: TranslationData = {
  objects: {
    ...
    crm_case: {
      ...
      _actions: {
        create_work_order: {
          label: '作業指示を作成',
          confirmText: 'このケースからフィールドサービスの作業指示を作成しますか？',
          successMessage: '作業指示を作成し、ケースに紐付けました。',
        },
        log_call: {
          label: '通話を記録',
    ...
    crm_asset: {
      ...
      pluralLabel: '設置資産',
      fields: {
        asset_number: { label: '資産番号' },
        name: { label: '資産名' },
        display_title: { label: '表示名' },
        crm_account: { label: '取引先' },
        crm_contact: { label: '現地担当者' },
        crm_product: { label: '製品 / 型式' },
        serial_number: { label: 'シリアル番号' },
        install_date: { label: '設置日' },
        site_address: { label: '設置住所' },
        site_location: { label: '設置位置' },
        warranty_start_date: { label: '保証開始日' },
        warranty_end_date: { label: '保証終了日' },
        is_under_warranty: { label: '保証対象' },
        crm_contract: { label: 'サービス契約' },
        last_service_date: { label: '最終サービス日' },
        owner: { label: '資産オーナー' },
        description: { label: 'メモ' },
        status: {
          label: 'ステータス',
          options: { installed: '設置済み', in_repair: '修理中', suspended: '停止中', decommissioned: '廃棄済み' },
        },
      },
      _views: {
        all_assets: { label: 'すべての資産' },
        asset_fleet_board: { label: '稼働状況ボード' },
        asset_map: { label: '資産マップ' },
        asset_warranty_calendar: { label: '保証期限カレンダー' },
        assets_out_of_warranty: { label: '保証切れ' },
        assets_in_repair: { label: '修理中' },
        my_assets: { label: '自分の資産' },
      },
    },
    ...
    crm_work_order: {
      ...
      pluralLabel: '作業指示',
      fields: {
        work_order_number: { label: '作業指示番号' },
        subject: { label: '件名' },
        display_title: { label: '表示名' },
        description: { label: '申告内容' },
        crm_account: { label: '取引先' },
        crm_contact: { label: '現地担当者' },
        crm_asset: { label: '資産' },
        crm_case: { label: '元のケース' },
        priority_rank: { label: '優先度ランク' },
        response_due_date: { label: '応答期限' },
        responded_date: { label: '応答日時' },
        is_sla_violated: { label: '応答SLA違反' },
        assigned_engineer: { label: 'フィールドエンジニア' },
        scheduled_start: { label: '予定開始' },
        scheduled_end: { label: '予定終了' },
        scheduled_date: { label: '予定日' },
        has_schedule_conflict: { label: '予定重複' },
        service_address: { label: '作業住所' },
        is_billable: { label: '有償訪問' },
        service_charge: { label: 'サービス料金' },
        work_performed: { label: '作業内容' },
        parts_used: { label: '使用部品' },
        labor_hours: { label: '作業時間' },
        completed_date: { label: '完了日時' },
        customer_signature: { label: '顧客署名' },
        signed_by: { label: '署名者' },
        signed_date: { label: '署名日時' },
        customer_rating: { label: '顧客満足度' },
        customer_feedback: { label: '顧客フィードバック' },
        owner: { label: 'サービス責任者' },
        is_closed: { label: 'クローズ済み' },
        internal_notes: { label: '社内メモ' },
        type: {
          label: '作業種別',
          options: { repair: '修理', maintenance: '予防保全', installation: '設置', inspection: '点検' },
        },
        origin: {
          label: '受付経路',
          options: { phone: '電話', email: 'メール', case: 'ケース', portal: '顧客ポータル', chat: 'チャット', proactive: '計画 / 予防' },
        },
        status: {
          label: 'ステータス',
          options: { new: '新規', scheduled: '予定済み', dispatched: '派遣済み', in_progress: '作業中', on_hold: '保留', completed: '完了', closed: 'クローズ', cancelled: 'キャンセル' },
        },
        priority: {
          label: '優先度',
        ...
        warranty_status: {
          label: '保証ステータス',
          options: { under_warranty: '保証内', out_of_warranty: '保証切れ', unknown: '不明' },
        },
      },
      _views: {
        all_work_orders: { label: 'すべての作業指示' },
        work_order_board: { label: '作業ボード' },
        dispatch_calendar: { label: '配車カレンダー' },
        engineer_schedule: { label: 'エンジニア予定' },
        unassigned_work_orders: { label: '未割当' },
        work_orders_response_at_risk: { label: '応答期限間近' },
        billable_work_orders: { label: '有償訪問' },
        my_work_orders: { label: '自分の作業指示' },
      },
      _actions: {
        complete_work_order: {
          label: '訪問完了',
          confirmText: 'この作業指示の現地完了を登録しますか？',
          successMessage: '訪問を完了しました。',
        },
      },
    },
  },
  ...
  apps: {
    crm_enterprise: {
      ...
      navigation: {
        group_field_service: { label: 'フィールドサービス' },
  ...
  dashboards: {
    ...
    field_service_dashboard: {
      label: 'フィールドサービス',
      description: '派遣負荷、応答SLA、有償訪問、保証カバレッジ',
      widgets: {
        open_work_orders: { title: '未クローズ作業指示', description: 'クローズもキャンセルもされていない訪問' },
        response_breaches: { title: '応答SLA違反', description: '応答期限を過ぎても未対応の作業指示' },
        billable_visits: { title: '有償訪問', description: '保証切れのため顧客に請求できる訪問' },
        avg_field_csat: { title: '平均満足度', description: '訪問後アンケートの平均評価（1-5）' },
        work_orders_by_status: { title: 'ステータス別作業指示', description: '受付から完了までの進行状況' },
        work_orders_by_priority: { title: '優先度別の未クローズ作業', description: '進行中作業の緊急度構成' },
        work_orders_by_type: { title: '種別ごとの作業', description: '修理・予防保全・設置の比率' },
        assets_by_status: { title: 'ステータス別設置資産', description: '稼働中と停止中の台数' },
        assets_by_coverage: { title: '保証カバレッジ', description: '保証内と保証切れの比率' },
        billing_by_warranty_status: { title: '保証ステータス別の訪問と売上', description: '無償対応と有償対応の件数と金額' },
      },
    },
  },
};
