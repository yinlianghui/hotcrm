...
export const esES: TranslationData = {
  objects: {
    ...
    crm_case: {
      ...
      _actions: {
        create_work_order: {
          ...
          confirmText: '¿Generar una orden de servicio en campo a partir de este caso?',
          successMessage: 'Orden de trabajo creada y vinculada al caso.',
        },
        log_call: {
    ...
    crm_asset: {
      ...
      pluralLabel: 'Activos',
      fields: {
        asset_number: { label: 'Número de Activo' },
        name: { label: 'Nombre del Activo' },
        display_title: { label: 'Título' },
        crm_account: { label: 'Cuenta' },
        crm_contact: { label: 'Contacto en Sitio' },
        crm_product: { label: 'Producto / Modelo' },
        serial_number: { label: 'Número de Serie' },
        install_date: { label: 'Fecha de Instalación' },
        site_address: { label: 'Dirección del Sitio' },
        site_location: { label: 'Ubicación del Sitio' },
        warranty_start_date: { label: 'Inicio de Garantía' },
        warranty_end_date: { label: 'Fin de Garantía' },
        is_under_warranty: { label: 'En Garantía' },
        crm_contract: { label: 'Contrato de Servicio' },
        last_service_date: { label: 'Último Servicio' },
        owner: { label: 'Responsable del Activo' },
        description: { label: 'Notas' },
        status: {
          label: 'Estado',
          options: { installed: 'Instalado', in_repair: 'En Reparación', suspended: 'Suspendido', decommissioned: 'Retirado' },
        },
      },
      _views: {
        all_assets: { label: 'Todos los Activos' },
        asset_fleet_board: { label: 'Estado del Parque' },
        asset_map: { label: 'Activos por Ubicación' },
        asset_warranty_calendar: { label: 'Calendario de Vencimiento de Garantía' },
        assets_out_of_warranty: { label: 'Fuera de Garantía' },
        assets_in_repair: { label: 'En Reparación' },
        my_assets: { label: 'Mis Activos' },
      },
    },

    crm_work_order: {
      label: 'Orden de Trabajo',
      pluralLabel: 'Órdenes de Trabajo',
      fields: {
        work_order_number: { label: 'Número de Orden' },
        subject: { label: 'Asunto' },
        display_title: { label: 'Título' },
        description: { label: 'Problema Reportado' },
        crm_account: { label: 'Cuenta' },
        crm_contact: { label: 'Contacto en Sitio' },
        crm_asset: { label: 'Activo' },
        crm_case: { label: 'Caso de Origen' },
        priority_rank: { label: 'Rango de Prioridad' },
        response_due_date: { label: 'Respuesta Comprometida' },
        responded_date: { label: 'Respondido el' },
        is_sla_violated: { label: 'SLA de Respuesta Incumplido' },
        assigned_engineer: { label: 'Técnico de Campo' },
        scheduled_start: { label: 'Inicio Programado' },
        scheduled_end: { label: 'Fin Programado' },
        scheduled_date: { label: 'Fecha Programada' },
        has_schedule_conflict: { label: 'Conflicto de Agenda' },
        service_address: { label: 'Dirección de Servicio' },
        is_billable: { label: 'Visita Facturable' },
        service_charge: { label: 'Cargo por Servicio' },
        work_performed: { label: 'Trabajo Realizado' },
        parts_used: { label: 'Repuestos Utilizados' },
        labor_hours: { label: 'Horas de Trabajo' },
        completed_date: { label: 'Completado el' },
        customer_signature: { label: 'Firma del Cliente' },
        signed_by: { label: 'Firmado por' },
        signed_date: { label: 'Firmado el' },
        customer_rating: { label: 'Satisfacción del Cliente' },
        customer_feedback: { label: 'Comentarios del Cliente' },
        owner: { label: 'Supervisor de Servicio' },
        is_closed: { label: 'Cerrada' },
        internal_notes: { label: 'Notas Internas' },
        type: {
          label: 'Tipo de Trabajo',
          options: { repair: 'Reparación', maintenance: 'Mantenimiento Preventivo', installation: 'Instalación', inspection: 'Inspección' },
        },
        origin: {
          label: 'Reportado Vía',
          options: { phone: 'Teléfono', email: 'Correo', case: 'Caso de Soporte', portal: 'Portal del Cliente', chat: 'Chat / MI', proactive: 'Proactivo / Programado' },
        },
        status: {
          label: 'Estado',
          options: { new: 'Nueva', scheduled: 'Programada', dispatched: 'Despachada', in_progress: 'En Curso', on_hold: 'En Espera', completed: 'Completada', closed: 'Cerrada', cancelled: 'Cancelada' },
        },
        priority: {
          label: 'Prioridad',
        ...
        warranty_status: {
          ...
          options: { under_warranty: 'En Garantía', out_of_warranty: 'Fuera de Garantía', unknown: 'Desconocido' },
        },
      },
      _views: {
        all_work_orders: { label: 'Todas las Órdenes' },
        work_order_board: { label: 'Tablero de Órdenes' },
        dispatch_calendar: { label: 'Calendario de Despacho' },
        engineer_schedule: { label: 'Agenda de Técnicos' },
        unassigned_work_orders: { label: 'Pendientes de Despacho' },
        work_orders_response_at_risk: { label: 'Respuesta en Riesgo' },
        billable_work_orders: { label: 'Visitas Facturables' },
        my_work_orders: { label: 'Mis Órdenes' },
      },
      _actions: {
        complete_work_order: {
          label: 'Completar Visita',
          confirmText: '¿Registrar la finalización en sitio de esta orden?',
          successMessage: 'Visita completada.',
        },
      },
    },
  },
  ...
  apps: {
    crm_enterprise: {
      ...
      navigation: {
        group_field_service: { label: 'Servicio en Campo' },
  ...
  dashboards: {
    ...
    field_service_dashboard: {
      label: 'Servicio en Campo',
      description: 'Carga de despacho, SLA de respuesta, visitas facturables y cobertura de garantía',
      widgets: {
        open_work_orders: { title: 'Órdenes Abiertas', description: 'Visitas aún no cerradas ni canceladas' },
        response_breaches: { title: 'Incumplimientos de Respuesta', description: 'Órdenes que superaron su plazo de respuesta sin atender' },
        billable_visits: { title: 'Visitas Facturables', description: 'Visitas fuera de garantía, cobrables al cliente' },
        avg_field_csat: { title: 'Satisfacción Media', description: 'Valoración media tras la visita (1-5)' },
        work_orders_by_status: { title: 'Órdenes por Estado', description: 'Flujo abierto desde la recepción hasta la finalización' },
        work_orders_by_priority: { title: 'Trabajo Abierto por Prioridad', description: 'Mezcla de urgencia de lo que sigue abierto' },
        work_orders_by_type: { title: 'Trabajo por Tipo', description: 'Reparación frente a mantenimiento e instalación' },
        assets_by_status: { title: 'Parque Instalado por Estado', description: 'Cuánto equipo está operativo y cuánto está parado' },
        assets_by_coverage: { title: 'Cobertura de Garantía', description: 'Unidades aún cubiertas frente a facturables' },
        billing_by_warranty_status: { title: 'Visitas e Ingresos por Estado de Garantía', description: 'Qué reparamos gratis, qué cobramos y cuánto vale' },
      },
    },
  },
};
