...
export const zhCN: TranslationData = {
  objects: {
    ...
    crm_case: {
      ...
      _actions: {
        create_work_order: {
          label: '创建服务工单',
          confirmText: '基于该服务案例创建上门服务工单？',
          successMessage: '工单已创建并关联到该案例。',
        },
        log_call: {
          label: '记录通话',
    ...
    crm_asset: {
      ...
      pluralLabel: '设备档案',
      fields: {
        asset_number: { label: '设备编号' },
        name: { label: '设备名称' },
        display_title: { label: '显示标题' },
        crm_account: { label: '客户' },
        crm_contact: { label: '现场联系人' },
        crm_product: { label: '产品 / 型号' },
        serial_number: { label: '序列号' },
        install_date: { label: '安装日期' },
        site_address: { label: '安装地址' },
        site_location: { label: '安装坐标' },
        warranty_start_date: { label: '保修开始' },
        warranty_end_date: { label: '保修截止' },
        is_under_warranty: { label: '在保' },
        crm_contract: { label: '服务合同' },
        last_service_date: { label: '最近服务日期' },
        owner: { label: '设备负责人' },
        description: { label: '备注' },
        status: {
          label: '状态',
          options: { installed: '已安装', in_repair: '维修中', suspended: '已停用', decommissioned: '已报废' },
        },
      },
      _views: {
        all_assets: { label: '全部设备' },
        asset_fleet_board: { label: '设备状态看板' },
        asset_map: { label: '设备分布地图' },
        asset_warranty_calendar: { label: '保修到期日历' },
        assets_out_of_warranty: { label: '已过保设备' },
        assets_in_repair: { label: '维修中设备' },
        my_assets: { label: '我负责的设备' },
      },
    },
    ...
    crm_work_order: {
      ...
      fields: {
        ...
        crm_contact: { label: '现场联系人' },
        crm_asset: { label: '设备' },
        crm_case: { label: '来源服务案例' },
        priority_rank: { label: '优先级排序值' },
        response_due_date: { label: '响应截止时间' },
        responded_date: { label: '响应时间' },
        is_sla_violated: { label: '响应超时' },
        assigned_engineer: { label: '现场工程师' },
        scheduled_start: { label: '计划开始' },
        scheduled_end: { label: '计划结束' },
        scheduled_date: { label: '计划日期' },
        has_schedule_conflict: { label: '排期冲突' },
        service_address: { label: '服务地址' },
        is_billable: { label: '收费工单' },
        service_charge: { label: '服务费用' },
        work_performed: { label: '服务内容' },
        parts_used: { label: '更换配件' },
        labor_hours: { label: '工时' },
        completed_date: { label: '完成时间' },
        customer_signature: { label: '客户签字' },
        signed_by: { label: '签字人' },
        signed_date: { label: '签字时间' },
        customer_rating: { label: '客户满意度' },
        customer_feedback: { label: '客户反馈' },
        owner: { label: '服务主管' },
        is_closed: { label: '已关闭' },
        ...
        type: {
          label: '工单类型',
          options: { repair: '维修', maintenance: '预防性保养', installation: '安装', inspection: '巡检' },
        },
        origin: {
          label: '报修渠道',
          options: { phone: '电话', email: '邮件', case: '服务案例', portal: '客户门户', chat: '即时通讯', proactive: '主动 / 计划' },
        },
        status: {
          label: '状态',
          options: { new: '新建', scheduled: '已排期', dispatched: '已派工', in_progress: '进行中', on_hold: '挂起', completed: '已完工', closed: '已关闭', cancelled: '已取消' },
        },
        priority: {
          label: '优先级',
          options: { low: '低', medium: '普通', high: '高', critical: '紧急' },
        },
        warranty_status: {
          label: '保修状态',
          options: { under_warranty: '保修期内', out_of_warranty: '已过保', unknown: '未知' },
        },
      },
      _views: {
        all_work_orders: { label: '全部工单' },
        work_order_board: { label: '工单看板' },
        dispatch_calendar: { label: '派工日历' },
        engineer_schedule: { label: '工程师排期' },
        unassigned_work_orders: { label: '待派工' },
        work_orders_response_at_risk: { label: '响应临期' },
        billable_work_orders: { label: '收费工单' },
        my_work_orders: { label: '我的工单' },
      },
      _actions: {
        complete_work_order: {
          label: '完工登记',
          confirmText: '登记本次上门的完工信息？',
          successMessage: '工单已完工。',
        },
      },
    },
  },
  ...
  apps: {
    crm_enterprise: {
      ...
      navigation: {
        group_field_service: { label: '现场服务' },
        nav_work_order: { label: '服务工单' },
        nav_dispatch: { label: '派工看板' },
        nav_engineer_schedule: { label: '工程师排期' },
        nav_asset: { label: '设备档案' },
        nav_field_service_dashboard: { label: '现场服务概览' },
        nav_home: { label: '首页' },
  ...
  dashboards: {
    ...
    field_service_dashboard: {
      label: '现场服务',
      description: '派工负荷、响应时效、收费工单与设备保修覆盖',
      widgets: {
        open_work_orders: { title: '未关闭工单', description: '尚未关闭或取消的上门工单' },
        response_breaches: { title: '响应超时', description: '已过响应截止时间仍无人响应的工单' },
        billable_visits: { title: '收费工单', description: '设备已过保，本次上门需要收费' },
        avg_field_csat: { title: '平均满意度', description: '完工回访平均评分（1-5）' },
        work_orders_by_status: { title: '工单状态分布', description: '从受理到完工的在途工单' },
        work_orders_by_priority: { title: '未关闭工单优先级', description: '在途工单的紧急程度构成' },
        work_orders_by_type: { title: '工单类型分布', description: '维修 / 保养 / 安装的比例' },
        assets_by_status: { title: '设备状态分布', description: '多少设备在运行，多少设备停机' },
        assets_by_coverage: { title: '保修覆盖率', description: '仍在保修期内与已过保设备的比例' },
        billing_by_warranty_status: { title: '按保修状态统计工单与收入', description: '免费维修、收费维修各自的量与金额' },
      },
    },
  },
};
